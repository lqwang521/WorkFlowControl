//
//  HTMIABCChooseFromOrganizationTreeViewController.h
//  MXClient
//
//  Created by wlq on 16/6/28.
...
@interface HTMIABCChooseFromOrganizationTreeViewController : HTMIWFCBaseViewController
