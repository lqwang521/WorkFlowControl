...
#import "UIImage+HTMIWFCWM.h"#import "UIImage+HTMIWFCWM.h"
@interface HTMIWFCUzysAssetsViewCell()
...
@end
@implementation HTMIWFCUzysAssetsViewCell
...
+ (void)initialize
{
    ...
    //使用我们自己的bundle
    videoIcon       = [UIImage getPNGImageHTMIWFC:@"uzysAP_ico_assets_video"];
...
- (void)applyData:(ALAsset *)asset
{
    ...
    self.title  = [HTMIWFCUzysAssetsViewCell getTimeStringOfTimeInterval:[[asset valueForProperty:ALAssetPropertyDuration] doubleValue]];
}
