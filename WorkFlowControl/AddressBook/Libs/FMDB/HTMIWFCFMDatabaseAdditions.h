...
@interface HTMIWFCFMDatabase (HTMIWFCFMDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `HTMIWFCFMDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `HTMIWFCFMResultSet` of schema; `nil` on error.
