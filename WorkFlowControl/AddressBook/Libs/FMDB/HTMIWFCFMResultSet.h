...
@interface HTMIWFCFMResultSet : NSObject {
    HTMIWFCFMDatabase          *_parentDB;
    HTMIWFCFMStatement         *_statement;
...
/** `HTMIWFCFMStatement` used by result set. */

@property (atomic, retain) HTMIWFCFMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<HTMIWFCFMStatement>`
 
 @param statement A `<HTMIWFCFMStatement>` to be performed
 
 @param aDB A `<FMDatabase>` to be used
 
 @return A `HTMIWFCFMResultSet` on success; `nil` on failure
 */

+ (instancetype)resultSetWithStatement:(HTMIWFCFMStatement *)statement usingParentDatabase:(HTMIWFCFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(HTMIWFCFMDatabase *)newDb;
