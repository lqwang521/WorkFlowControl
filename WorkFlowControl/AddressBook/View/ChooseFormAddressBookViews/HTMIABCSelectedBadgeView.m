...
@interface HTMIABCSelectedBadgeView ()
...
@implementation HTMIABCSelectedBadgeView

/*
 最简单的数字提示view,没有涉及到字体，边框，内容的自适应等
 */

+(HTMIABCSelectedBadgeView *)initWithString:(NSString *)string withTextColor:(UIColor *)textColor
{
