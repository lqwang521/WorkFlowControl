//
// UIScrollView+HTMIWFCSVPullToRefresh.h
//
...
@class HTMIWFCSVPullToRefreshView;

@interface UIScrollView (HTMIWFCSVPullToRefresh)
...
@property (nonatomic, strong, readonly) HTMIWFCSVPullToRefreshView *pullToRefreshView;
...
@interface HTMIWFCSVPullToRefreshView : UIView
