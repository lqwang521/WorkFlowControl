//
// UIScrollView+HTMIWFCSVInfiniteScrolling.m
//
...
#import "UIScrollView+HTMIWFCSVInfiniteScrolling.h"


static CGFloat const HTMIWFCSVInfiniteScrollingViewHeight = 60;
...
@interface HTMIWFCSVInfiniteScrollingView ()
...
#pragma mark - UIScrollView (HTMIWFCSVInfiniteScrollingView)
#import <objc/runtime.h>

static char UIScrollViewInfiniteScrollingView;
UIEdgeInsets scrollViewOriginalContentInsets;

@implementation UIScrollView (HTMIWFCSVInfiniteScrolling)
...
- (void)addInfiniteScrollingWithActionHandler:(void (^)(void))actionHandler {
    ...
    if(!self.infiniteScrollingView) {
        HTMIWFCSVInfiniteScrollingView *view = [[HTMIWFCSVInfiniteScrollingView alloc] initWithFrame:CGRectMake(0, self.contentSize.height, self.bounds.size.width, HTMIWFCSVInfiniteScrollingViewHeight)];
...
- (void)setInfiniteScrollingView:(HTMIWFCSVInfiniteScrollingView *)infiniteScrollingView {
...
- (HTMIWFCSVInfiniteScrollingView *)infiniteScrollingView {
...
- (void)setShowsInfiniteScrolling:(BOOL)showsInfiniteScrolling {
    ...
    if(!showsInfiniteScrolling) {
      ...
      if (!self.infiniteScrollingView.isObserving) {
        ...
        self.infiniteScrollingView.frame = CGRectMake(0, self.contentSize.height, self.infiniteScrollingView.bounds.size.width, HTMIWFCSVInfiniteScrollingViewHeight);
      }
    }
}
...
#pragma mark - HTMIWFCSVInfiniteScrollingView
@implementation HTMIWFCSVInfiniteScrollingView
...
- (void)setScrollViewContentInsetForInfiniteScrolling {
    UIEdgeInsets currentInsets = self.scrollView.contentInset;
    currentInsets.bottom = self.originalBottomInset + HTMIWFCSVInfiniteScrollingViewHeight;
    [self setScrollViewContentInset:currentInsets];
}
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {    
    if([keyPath isEqualToString:@"contentOffset"])
        ...
        [self layoutSubviews];
        self.frame = CGRectMake(0, self.scrollView.contentSize.height, self.bounds.size.width, HTMIWFCSVInfiniteScrollingViewHeight);
    }
}
