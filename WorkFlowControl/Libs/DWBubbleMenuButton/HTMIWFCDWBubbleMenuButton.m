...
@interface HTMIWFCDWBubbleMenuButton ()
...
@implementation HTMIWFCDWBubbleMenuButton
...
//    }
    ...
    [self.delegate changeViewImage:@"btn_operation_homelabel_on"];
...
- (void)_finishCollapse {
    self.frame = self.newFrame;//_originFrame;
}
