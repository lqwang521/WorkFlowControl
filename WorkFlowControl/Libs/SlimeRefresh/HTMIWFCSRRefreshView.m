...
#import "HTMIWFCSRDefine.h"
#import <QuartzCore/QuartzCore.h>
#import "UIImage+HTMIWFCWM.h"
@interface HTMIWFCSRRefreshView()
...
@implementation HTMIWFCSRRefreshView {
...
- (id)initWithHeight:(CGFloat)height
{
    ...
    if (self) {
        _slime = [[HTMIWFCSRSlimeView alloc] initWithFrame:
        ...
        _refleshView = [[UIImageView alloc] initWithImage:[UIImage getPNGImageHTMIWFC:@"sr_refresh"]];
...
- (void)pullApart:(HTMIWFCSRRefreshView*)refreshView
{
    //拉断了
    self.broken = YES;
    _unmissSlime = YES;
