...
#import "HTMIWFCDCPathButtonConstant.h"
#import "HTMIWFCDCSubButton.h"

typedef enum{
    kHTMIWFCDCPathButtonRotationNormal = 0,
    kHTMIWFCDCPathButtonRotationReverse,
}HTMIWFCDCPathButtonRotationOrientation;

@protocol HTMIWFCDCPathButtonDelegate <NSObject>
@optional
...
@class HTMIWFCDCPathButton;
@interface HTMIWFCDCPathButton : UIView<HTMIWFCDCSubButtonDelegate>

- (id)initHTMIWFCDCPathButtonWithSubButtons:(NSInteger)buttonCount
...
@property (nonatomic, weak) id<HTMIWFCDCPathButtonDelegate> delegate;
...
@property (strong, nonatomic) HTMIWFCDCSubButton *subButton;
