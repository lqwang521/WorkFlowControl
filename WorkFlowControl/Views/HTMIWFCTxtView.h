...
@class HTMIWFCTextView;
@class HTMIWFCTextField;

typedef void(^HTMIWFCTxtViewBlock)(NSString *string);

typedef void(^HTMIWFCTextViewEditEndBlock)(NSString *string);
...
@interface HTMIWFCTxtView : UIView
...
@property(nonatomic,weak)id <HTMIWFCTxtViewProtocol> delegate;

/**
 *  textView编辑完成后收键盘
 */
@property (nonatomic, copy) HTMIWFCTextViewEditEndBlock editEndBlock;

/**
 *  block 编辑字段
 */
@property (nonatomic, copy) HTMIWFCTxtViewBlock editBlock;
/**
 *  文本类型
 */
...
#pragma mark - 控件
/** 多行文本框 */
@property (nonatomic, strong)HTMIWFCTextField *textField;
/** 多行文本框 */
@property (nonatomic, strong)HTMIWFCTextView *textView;
/** 左侧Label */
