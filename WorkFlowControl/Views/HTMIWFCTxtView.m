...
#import "HTMIWFCTextView.h"
#import "HTMIWFCTextField.h"

#import "UIView+HTMIWFCExtension.h"
...
@interface HTMIWFCTxtView ()<UITextFieldDelegate,UITextViewDelegate>
{
...
@implementation HTMIWFCTxtView

- (instancetype)initWithFrame:(CGRect)frame textType:(TextType)textType beforValue:(NSString *)beforValue textValue:(NSString *)textValue endValue:(NSString *)endValue isMustInput:(BOOL)isMustInput textFont:(NSInteger)textFont maxLength:(NSInteger)maxLength{
    ...
    if (self) {
        ...
        if (beforValue.length > 0) {
            self.beforValueWidth = [self labelSizeWithMaxWidth:0 content:beforValue FontOfSize:self.labelFontSize].width;
        ...
        if (endValue.length > 0) {
            self.endValueWidth = [self labelSizeWithMaxWidth:0 content:endValue FontOfSize:self.labelFontSize].width;
...
- (UIColor *)highlightBorderColor{
    if (!_highlightBorderColor) {
        _highlightBorderColor = RGB(41, 123, 251);
    }
...
- (UIColor *)nomarlBorderColor{
    if (!_nomarlBorderColor) {
        _nomarlBorderColor = RGB(233, 233, 233);
    }
...
- (UILabel *)beforLabel{
    if (!_beforLabel) {
        ...
        _beforLabel.font = [UIFont systemFontOfSize:self.labelFontSize];
...
- (UILabel *)endLabel{
    if (!_endLabel) {
        ...
        _endLabel.font = [UIFont systemFontOfSize:self.labelFontSize];
...
- (NSDictionary *)attributesDic{
    if (!_attributesDic) {
        ...
        _attributesDic = @{ NSFontAttributeName:[UIFont systemFontOfSize:self.labelFontSize], NSParagraphStyleAttributeName:paragraphStyle,NSKernAttributeName:@(self.charSpace)};
    }
...
- (UITextField *)textField{
    if (!_textField) {
        ...
        _textField = [[HTMIWFCTextField alloc] initWithFrame:CGRectMake(self.marginSize + leftLabelMaxX, (kOwnHeight-kH6(40))/2, kOwnWidth - (self.marginSize * 2) - leftLabelMaxX - rightLabelMinX, kOwnHeight - kH6(10))];
...
- (HTMIWFCTextView *)textView{
    ...
    if (!_textView) {
        ...
        _textView = [[HTMIWFCTextView alloc] initWithFrame:CGRectMake(self.marginSize + leftLabelMaxX, kH6(5), kOwnWidth - (self.marginSize * 2) - leftLabelMaxX - rightLabelMinX, kOwnHeight - kH6(10))];
...
- (UIFont *)inputViewFont{
    if (!_inputViewFont) {
        _inputViewFont = [UIFont systemFontOfSize:self.labelFontSize];
    }
...
- (void)setErrorBorderColor:(UIColor *)errorBorderColor{
    ...
    if (!_errorBorderColor) {
        _errorBorderColor = RGB(237, 150, 151);//默认的红色
    }
